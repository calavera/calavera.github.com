...
Then RubyConf X arrived and I had the pleasure to meet Charles among other fellow rubists. "Charlie":http://twitter.com/headius and "Tom":http://twitter.com/tom_enebo were at the stage when they show a "brief code":http://is.gd/gYCMr to write JRuby extensions with Mirah and this idea came to my mind, why do we write Hudson extensions with "Mirah":http://mirah.org??!! At the end, it compiles to JVM bytecode so we won't bump into all those problems that we had with JRuby.
